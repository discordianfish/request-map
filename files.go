...
<html>
  <head>
    ...
    <script type="text/javascript"
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA37BthbtrC81p11vCJzcIjjzx8eEK1snQ">
    </script>
    <script type="text/javascript">
			// https://github.com/trevnorris/cbuffer/raw/master/cbuffer.js
    ...
    <script type="text/javascript">
			...
			var ws_url = "ws://" + url.hostname + ":" + url.port + "/haproxy"

      var home = new google.maps.LatLng(37.790850,-122.402246);

      var cons = CBuffer(10)
      cons.overflow = function(conn) { conn.setMap(null) }
      ...
      function initialize() {
        ...
        ws.onmessage = function (event) {
          ...
          var conn = new google.maps.Polyline({
            path: [ new google.maps.LatLng(point.Lat, point.Lng), home ],
            strokeWeight: 2,
            strokeOpacity: 0.3,
            geodesic: true,
          })
